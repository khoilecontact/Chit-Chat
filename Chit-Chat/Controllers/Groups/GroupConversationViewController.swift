...
class GroupConversationViewController: UIViewController {
    ...
    private func startListeningForConversations() {
        ...
        DatabaseManager.shared.getAllGroupConversation(for: safeEmail) { [weak self] results in
            ...
            case .failure(let error):
                ...
                print("Failed to get group conversations: \(error)")
            }
        }
    }
    ...
    func fakeData() {
        ...
        conversations.append(GroupMessagesCollection(id: "fir5tM3ss4g35", name: "Doctor", groupId: "fir5tM3ss4g35", latestMessage: latestMessage))
        conversations.append(GroupMessagesCollection(id: "s3c0ndM3ss4g35", name: "IT", groupId: "s3c0ndM3ss4g35", latestMessage: latestMessage))
    ...
    func rightBarButton() {
        let groupConversations = UIBarButtonItem(barButtonSystemItem: .add, target: self, action: #selector(createNewGroupTapped))
    ...
    func openConversation(_ model: GroupMessagesCollection) {
        // open chat space
        let vc = GroupChatViewController(with: model.id, groupid: model.groupId, name: model.name)
        vc.title = model.name
    ...
    @objc func createNewGroupTapped() {
